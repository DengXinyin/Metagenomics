...
def main():
    ...
    parser.add_argument('--res6', type=str, required=True, help='the dir of res6')
    ...
    res6 = os.path.abspath(args.res6)
...
cp -r {5} {1}
cp -r {6} {1}
cp -r {7}/README_bins.txt {1}/Result'''.format(res1, wkdir, res2, res3, res4, res5, res6, readme)
    os.system(cmd)
