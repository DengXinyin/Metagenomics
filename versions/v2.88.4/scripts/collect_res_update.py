...
def collect_kraken2(outdir, raw_dir=None, tax_base_dir=None, tax_diff_dir=None):
    ...
    # Delivery modules 1-16 are stored below Result/group1. Keep Kraken2 in
    # the same group-level hierarchy so it appears alongside those modules.
    kraken_dir = os.path.join(outdir, 'Result', 'group1', '17-Kraken2')
    manifest_rows = []
